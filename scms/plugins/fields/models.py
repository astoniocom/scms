...
class Fields(SCMSPluginModel):
    ...
    extra = models.IntegerField(_("Extra"), null= True, blank=True, db_index=False, help_text='Количество пустых полей предлагаемых для ввода.')
    ...
    max_num = models.IntegerField(_("Max fields"),  null= True,blank=True, db_index=False, help_text='Максимальное количество полей ввода')    
    ...
    filter_type = models.IntegerField(_("Filter Type"), choices=((1, 'Тип %s'%1),(2, 'Тип %s'%2),), null= True, blank=True, default=None, help_text='Тип фильтра, при его использовании')	
