...
class SCMSRelatedFieldWidgetWrapper(RelatedFieldWidgetWrapper):
    ...
    def __init__(self, widget, rel, admin_site, vocabulary, language, *args, **kwargs):
        super().__init__(widget, rel, admin_site, vocabulary, language, *args, **kwargs)
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        context['url_params'] += "&vocabulary=%s&language=%s" % (self.vocabulary, self.language)        
